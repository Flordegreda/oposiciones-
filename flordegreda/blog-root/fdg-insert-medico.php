<?php
/**
 * One-shot: publish médico 1845 article. DELETE after use.
 */
require __DIR__ . '/wp/wp-load.php';

if ( ( $_GET['token'] ?? '' ) !== 'fdg-insert-medico-2026' ) {
	status_header( 403 );
	exit( 'Forbidden' );
}
...
<p>Uno abre un documento de 1845 esperando datos y burocracia, y se encuentra con la vida. El precio del sueño interrumpido. El trigo convertido en moneda. La atención gratis a quien no tenía nada. El aviso de la muerte para arreglar el alma. Y un médico joven, recién llegado, cargando sobre sus hombros con la salud de todo un pueblo.</p>

<p>Rescatar estos papeles del olvido es, en el fondo, devolverle la voz a esa gente: a los que cuidaban y a los que eran cuidados. Porque nuestra historia no está solo en los grandes acontecimientos. También está, y quizá sobre todo, en veinte reales por salir de la cama una noche de invierno.</p>
HTML;
